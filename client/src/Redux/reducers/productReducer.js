import { LOADINGPRODUCTS, GET_ALLPRODUCTS_SUCCESS, GET_ALLPRODUCTS_FAIL, ADD_PRODUCT_SUCCESS, ADD_PRODUCT_FAIL, GET_ONEPRODUCTS_SUCCESS, GET_ONEPRODUCTS_FAIL, EDIT_PRODUCT_SUCCESS, DELETE_ONEPRODUCTS_SUCCESS } from "../action-type/action-type-product"
const IntialState = {
    products: [],
    errors: null,
    loading: false,
